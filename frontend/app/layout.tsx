...
const jsonLd = [
  ...
  },
  {
    ...
    // AI 사진 진단이 들어오면서 대표 기능이 바뀌어 설명·기능 목록을 갱신함.
    // 진단 페이지에 WebApplication을 또 두면 같은 엔티티가 둘로 갈리므로, 앱 정의는
    // 여기 한 곳만 두고 /diagnose에는 FAQPage만 둔다.
    "@context": "https://schema.org",
    "@type": "WebApplication",
    name: SITE_NAME,
    url: SITE_URL,
    ...
    inLanguage: "ko-KR",
    description:
      "식물 사진을 올리면 AI가 종류와 상태를 진단하고, 식물도감·가드닝팁과 함께 마이가든에서 기록하며 키우는 식물 관리 서비스.",
    featureList: [
      "사진 한 장으로 식물 종류·건강 상태 AI 진단",
      "진단 기록을 마이가든에 저장",
